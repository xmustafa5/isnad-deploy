...
export default function Company() {
    return (
        <div className=" bg-red-60 overflow-hidden flex relative w-[398px] h-[256px] p-4 flex-col justify-end items-end gap-2 flex-shrink-0 rounded-[16px]">
            ...
            <div className="absolute left-4 top-4 flex justify-end items-center gap-1 px-3 py-2 rounded-[24px] bg-[rgba(84,50,29,0.32)] backdrop-blur-[2px]">
                <div className='flex items-center gap-1 text-white'>
                    <p className='text-white typography-subtitle-18-medium'>30</p>
            ...
            <div className="relative  flex flex-col items-start gap-2 self-stretch">
                <div className="flex justify-end items-center gap-4 self-stretch">
                    <div className="flex flex-col justify-center items-end gap-1 flex-1">
                        <p className='text-[#FBF5EF] typography-subtitle-18-Light '>دايز للاثاث Daze Furniture</p>
                        <p className="text-[#AAB7CB] text-center font-[Alilato] text-[12px] font-normal leading-[120%]">
                            للمفروشات المنزلية</p>
                    </div>
                ...
                <div className="flex flex-col justify-center items-end gap-2 self-stretch pt-3 border-t border-white/10">
                    <div className="flex justify-end items-center gap-2 self-stretch">
                        <p className="text-text-whaite typography-body-14-light">بغداد/اليرموك/شارع نادي الصيد</p>
