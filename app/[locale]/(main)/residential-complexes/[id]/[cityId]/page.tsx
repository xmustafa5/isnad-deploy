...
function CardProperty() {
    ...
    return (
        <div className="flex h-[347px] min-w-[320px] relative overflow-hidden max-w-[536px] p-[16px] justify-end items-end gap-[8px] flex-1 rounded-[16px] border border-stroke-border">
            <Image
                src="/images/company.png"
                fill
                alt="صورة العقار"
            ...
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(8,24,47,0)_0%,rgba(8,24,47,0.81)_86.5%)] z-10"></div>
