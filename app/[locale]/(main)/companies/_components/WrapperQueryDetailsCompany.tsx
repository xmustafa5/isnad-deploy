...
export default function WrapperQueryDetailsCompany({
  id,
  locale = "ar",
}: {
  id: string;
  ...
  const toggleBranchExpansion = (branchIndex: any) => {
...
`,
      ...
      >
          ...
          <div className="flex flex-col items-start gap-4 self-stretch">
            <div className="flex flex-col items-center gap-2 self-stretch">
              <div className="flex justify-center items-end gap-[25px] self-stretch">
                <div className="flex flex-col justify-center items-center w-[122px] h-[42px]"></div>
                <div
                  className="flex justify-center items-center w-[80px] h-[80px] overflow-hidden rounded-[145.455px] border-[3.333px] border-[rgba(255,255,255,0.09)]"
                  style={{ backgroundColor: "var(--bg-secondry, #08182F)" }}
                >
                  <img
                    src={company.logo || "/images/company-icon.png"}
                    alt="company-icon"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="flex flex-col justify-center items-center w-[122px]"></div>
              </div>
            ...
            {company.branches?.length > 0 && (
              <div className="flex justify-center w-full gap-3 pb-3">
                ...
                >
                  ...
                  >
                    <path
                      d="M8.28197 3H16.7163C19.6643 3 21.4993 5.08111 21.4993 8.02618V15.9731C21.4993 18.9182 19.6643 20.9993 16.7154 20.9993H8.28197C5.33398 20.9993 3.5 18.9182 3.5 15.9731V8.02618C3.5 5.08111 5.34274 3 8.28197 3Z"
                      stroke="white"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M12.7158 13.8103C12.7158 15.7153 14.9652 17.5357 15.3933 17.5357C15.8214 17.5357 18.0708 15.7153 18.0708 13.8103C18.0708 12.3315 16.8722 11.1328 15.3933 11.1328C13.9145 11.1328 12.7158 12.3315 12.7158 13.8103Z"
                      stroke="white"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M15.3936 13.7952V13.7852"
                      stroke="white"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      opacity="0.4"
                      d="M3.55469 8.21094H21.4898M9.26172 8.31641V21.0012"
                      stroke="white"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                  </svg>
                  <span className="text-[#B8C6E3] text-[14px] font-medium">
                    عرض الفروع
                  </span>
                </button>
              ...
              {company.governorate && (
                <div className="flex items-center gap-2 self-stretch">
                  ...
                  <p className="text-text-main text-right text-[14px] font-light leading-[140%]">
                    {company.governorate?.name?.[locale] ||
                      company.governorate?.name?.en}
                  </p>
                </div>
              )}
              {/* {company.branches?.length > 0 && (
        ...
        <div className="flex items-start gap-4 self-stretch px-6 pb-4">
          <div className="flex items-start gap-4 self-stretch w-full">
            {company?.links?.map((itemLink: any) => (
              <div
                key={itemLink.id}
                className="flex relative flex-col items-center px-2 py-1 gap-2 flex-[1_0_0]"
              >
      ...
      <div className="flex flex-col gap-8 flex-1">
        ...
        {company.description && (
          <div
            ...
            style={{
              ...
              backgroundColor:
                "var(--opacomplex-white-5, rgba(255, 255, 255, 0.05))",
              ...
              <div className="flex items-center gap-2 w-full">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M15.1895 12.4121C15.1895 11.8598 15.6372 11.4121 16.1895 11.4121H16.1985C16.7508 11.4121 17.1985 11.8598 17.1985 12.4121C17.1985 12.9644 16.7508 13.4121 16.1985 13.4121H16.1895C15.6372 13.4121 15.1895 12.9644 15.1895 12.4121Z"
                    fill="white"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M11.1807 12.4121C11.1807 11.8598 11.6284 11.4121 12.1807 11.4121H12.1897C12.742 11.4121 13.1897 11.8598 13.1897 12.4121C13.1897 12.9644 12.742 13.4121 12.1897 13.4121H12.1807C11.6284 13.4121 11.1807 12.9644 11.1807 12.4121Z"
                    fill="white"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7.17188 12.4121C7.17188 11.8598 7.61958 11.4121 8.17187 11.4121H8.18088C8.73316 11.4121 9.18088 11.8598 9.18088 12.4121C9.18088 12.9644 8.73316 13.4121 8.18088 13.4121H8.17187C7.61958 13.4121 7.17188 12.9644 7.17188 12.4121Z"
                    fill="white"
                  />
                </svg>
              </div>
        ...
        {company.departments?.length > 0 && (
          <div className="flex flex-col justify-center items-end gap-4 self-stretch rounded-[16px] ">
            <div className="flex flex-col items-end gap-[7px] self-stretch rounded-[16px]">
              <div className="flex items-center gap-2 w-full">
          ...
          >
            ...
            <div className="overflow-y-auto max-h-[60vh]">
              {company.branches?.map((branch: any, index: number) => (
                <div
                  key={branch.id}
                  className="p-4 border-b border-[rgba(255,255,255,0.05)] last:border-b-0"
                >
                    ...
                    <div className="flex items-center p-2 gap-2 rounded-[16px] bg-white/10">
                      ...
                      >
                        ...
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M12.2498 21.2499C12.2498 21.2499 4.97391 16.5107 4.79058 10.5972C4.66185 6.44502 8.12963 2.75 12.2498 2.75C16.3699 2.75 19.8368 6.44496 19.7099 10.5972C19.5255 16.6319 12.2498 21.2499 12.2498 21.2499Z"
                          stroke="#FBF5EF"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        />
                      ...
                      <div className="flex items-center justify-between w-full">
                        <div>
                          <p className="text-white text-[16px] font-medium">
                            {branch.governorate?.name?.[locale] ||
                              branch.governorate?.name?.en}
                          </p>
                          {branch.address && (
                        ...
                        >
                          <p className="text-[#97A8BF] text-[12px]">
                            {company.branches.length - index} فروع
                          </p>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
                            ...
                            className={`transition-transform duration-200 ${
                              expandedBranches.has(index) ? "rotate-180" : ""
                            }`}
                          >
                            <path
                              d="M4.375 7.08366L10.2083 12.917"
                              stroke="white"
                              strokeWidth="1.25"
                            ...
                            <path
                              opacity="0.4"
                              d="M10.208 12.917L16.0413 7.08366"
                              stroke="white"
                              strokeWidth="1.25"
                              strokeLinecap="square"
                            />
                      ...
                      {expandedBranches.has(index) && (
                        <div className="mt-3 p-3 bg-white/5 rounded-[8px] border border-white/10">
                          <div className="space-y-2">
                            ...
                            {branch.phone && (
                              <p className="text-text-gray1 text-[12px]">
                                <span className="text-white">الهاتف:</span>{" "}
                                {branch.phone}
                              </p>
                            )}
                            {branch.email && (
                            ...
                            {branch.location && (
                              <a
                                href={
                                  branch.location.startsWith("http")
                                    ? branch.location
                                    : `https://${branch.location}`
                                }
                                target="_blank"
                                rel="noopener noreferrer"
